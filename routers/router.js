...
const {
  getMyAppsData,
  postMyAppsData,
} = require("../controllers/myAppsDataController");

router.route("/my-apps").get(getMyAppsData).post(postMyAppsData);
...
const {
  getFutureData,
  postFutureData,
} = require("../controllers/futureDataController");

router.route("/future").get(getFutureData).post(postFutureData);
